...
using roleBasedAccessControlApi.jwtAuthCore.Interfaces;
using System.IdentityModel.Tokens.Jwt;
using System.Security.Claims;
using System.Text;

namespace roleBasedAccessCcontrolApi.jwtAuthCore.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<AuthServiceResponseDto> MakeStudentAsync(UpdatePermissionDto updatePermissionDto)
        {
            var user = await _userManager.FindByNameAsync(updatePermissionDto.UserName);
            ...
            return new AuthServiceResponseDto(true, "User is now an Student");
        }
        ...
        public async Task<AuthServiceResponseDto> SeedRolesAsync()
        {
            ...
            bool isStudentRoleExists = await _roleManager.RoleExistsAsync(StaticUserRoles.STUDENT);
            ...
            await _roleManager.CreateAsync(new ApplicationRole(StaticUserRoles.STUDENT, StaticUserRoles.USER_TITLE));
