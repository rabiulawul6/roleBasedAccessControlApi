...
namespace roleBasedAccessCcontrolApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("make-student")]
        public async Task<IActionResult> MakeStudent([FromBody] UpdatePermissionDto updatePermissionDto)
        {
            var operationResult = await _authService.MakeStudentAsync(updatePermissionDto);
