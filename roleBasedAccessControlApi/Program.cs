...
using roleBasedAccessCcontrolApi.jwtAuthCore.Identity.Factories;
using roleBasedAccessCcontrolApi.jwtAuthCore.Identity.Stores;
using roleBasedAccessControlApi.jwtAuthCore.Entities;
using roleBasedAccessControlApi.jwtAuthCore.Identity.Stores;
...
builder.Services.AddScoped<IAuthService, roleBasedAccessCcontrolApi.jwtAuthCore.Services.AuthService>();
